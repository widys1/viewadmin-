...
<head>
    ...
    <title>Admin | Widy's Laundry</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Admin | Widy's Laundry</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                     <a href="tables.html"><i class="fa fa-table fa-fw"></i> Data Pelanggan</a>
                                </li>
                                <li>
                                    <a href="tables.html"><i class="fa fa-table fa-fw"></i> Data Harga Laundry</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                        <a href="#"><i class="fa fa-files-o fa-fw"></i> Data Transaksi<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                        <li>
                            <a href="tables.html"><i class="fa fa-table fa-fw"></i> Laundry Masuk</a>
                        </li>
                        <li>
                            <a href="tables.html"><i class="fa fa-table fa-fw"></i> Laundry Keluar</a>
                        </li>
                        </ul>
                        <li>
                            <a href="tables.html"><i class="fa fa-table fa-fw"></i> Laporan</a>
                        </li>
                    </ul>
